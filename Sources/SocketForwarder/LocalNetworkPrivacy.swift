...
/// Utility function to raise the local network privacy prompt
/// so that a SocketForwarder can communicate through the
/// loopback interface.
///
/// This code is a literal copy of the sample code provided
/// in the local network security [technical note](https://developer.apple.com/documentation/technotes/tn3179-understanding-local-network-privacy).
public struct LocalNetworkPrivacy {
