...
struct APIServer: AsyncParsableCommand {
    ...
    func run() async throws {
        ...
        do {
            ...
            try initializeContainerService(appRoot: appRoot, pluginLoader: pluginLoader, log: log, routes: &routes)
    ...
    private func initializeContainerService(appRoot: URL, pluginLoader: PluginLoader, log: Logger, routes: inout [XPCRoute: XPCServer.RouteHandler]) throws {
